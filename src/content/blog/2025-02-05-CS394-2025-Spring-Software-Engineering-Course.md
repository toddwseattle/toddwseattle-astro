...
The course I will teach will have a very similar structure to [Chris Riesbeck's 394 Course](https://courses.cs.northwestern.edu/394/). We will have two team projects as the significant focus of the course. The first will be a startup-like project in React and Firebase. The second will be a client-oriented project where software is developed on behalf of a 'customer' outside of the students. Our second project will also explore issues with multi-agile team development.
...
A common survey is used for CS 394 to get into the course and the survey is available on the [CS 394 Course Page](https://courses.cs.northwestern.edu/394/) for admittance. Let us know if you have preferences between the courses. My class will be Tuesday & Thursday at 9:30 am, and [Professor Riesbeck's 394](https://courses.cs.northwestern.edu/394/) is Monday & Wednesday at 9:30 am. Students will need to coordinate times to meet with their team outside of class as well to work on the project. **Students will be expected to be in each class on time in person**. (See [FAQ](#faq) below).

#### Some more on Professor Warren   

This site provides a pretty complete background on me in [the profile on this site](/resume). I've been teaching off and on at Northwestern for more than ten years. I taught software engineering last year, and elements of CS394 also existed within the NUvention Web course I team-taught for more than 15 years. I'm a "pracademic"--that is, most of my approach is based on my work experience at big companies (Microsoft and Ford Motor Company) and startups. Most recently, I was involved in leading software at Ford Motor Company, where I was responsible for all in-vehicle software, connected cloud systems, and mobile applications. I will also be co-teaching a course in [corporate innovation](https://farley.northwestern.edu/news-events/news/articles/2024/innovating-from-within.html) for the second year in the Farley Center for Innovation and Entrepreneurship.

#### Guest Speakers

We will have a few guest speakers, some in person, some on Zoom for short Q & A's, though most learning will come from building projects in teams. In particular, we may have guests who have led software products at major tech companies, many of whom will be former students. [Jeff Henshaw](https://jeff.henshaw.org/), who was on the X-Box Founding team (but not an NU alum!), is confirmed for one of our May classes (he will also speak in an open class in Corporate Innovation).
