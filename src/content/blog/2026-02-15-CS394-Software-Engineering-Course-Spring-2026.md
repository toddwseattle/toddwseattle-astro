...
cover: "./394_2026_Willy_Swarm.png"
title: "Northwestern CS394 Spring Software Engineering Course 2026"
date: "2026-02-15"
tags:
  ["teaching", "software development", "software engineering", "northwestern"]
description: "This post is background primarily aimed at potential students of spring CS394 software engineering with me at Northwestern University and changes for 2026"
draft: false
...
Students also should be prepared for significant time to coordinate with their teams (And in the second project) with their clients outside of course times. How well you show up and perform with your team is fundamental to success in the course.
...
That said, last year I introduced a set of self-paced labs that were well received by students, and I will continue to develop and refine those labs for this year. The goal will be that all students who complete the course will be able to successfully pass the technical aspects of an interview as an intermediate-level React Developer; and to develop some better fluency with testing and Git/GitHub workflows, particularly in the context of AI-assisted development.

A common survey is used for CS 394 to get into the course and the survey is available on the [CS 394 Course Page](https://courses.cs.northwestern.edu/394/) for admittance. Let us know if you have preferences between the courses. My class will be Monday & Wednesday at 3:30 pm, and [Professor Riesbeck's 394](https://courses.cs.northwestern.edu/394/) is Monday & Wednesday at 9:30 am. Students will need to coordinate times to meet with their team outside of class as well to work on the project. **Students will be expected to be in each class on time in person**. (See [FAQ](#faq) below).
...
We will have a few guest speakers, some in person, some on Zoom for short Q & A's, though most learning will come from building projects in teams. In particular, we may have guests who have led software products at major tech companies, many of whom will be former students. In the past we have had people with software development experience at Google, Microsoft, Ford, OpenAI, and more.
...
The course is by permission only. Dr. Riesbeck and I use a common 394 application form, which is available on the [CS 394 Course Page](https://courses.cs.northwestern.edu/394/). Priority is given to those who are CS Majors/Masters, towards the end of their NU degree program, and those with web programming experience.
...
- 5-7 focused labs covering React fundamentals, TypeScript best practices, advanced Git and GitHub workflows, and testing techniques for AI-aided development workflows. Dr. Riesbeck covers similar topics in slightly different formats.
...
[The Agile Samurai by Jonathan Rasmusson](https://pragprog.com/titles/jtrap/the-agile-samurai/)

**What programming knowledge do I need to take the course?**

It's recommended students complete CS214 and another substantial programming course in any language before this course. Familiarity with web technologies, including JavaScript, CSS, HTML,

React, and database technology, will be required for the projects and is not covered directly in the syllabus. All students will be required to write software in React and JavaScript/TypeScript in the course. Every student must check in some code to their project under their GitHub ID to get a good grade in the course. If you want to get started, [look through Professor Riesbeck's excellent set of resources](https://courses.cs.northwestern.edu/394/guides/overviews.php#javascript).

**Can I use AI tools in the course**

With a few small caveats, Yes. Software development continues to change; and use of software agents (GitHub Copilot, Claude Code, Codex, OpenCode) is the latest. Most of the agile practices in the manifesto transcend these tools; and software engineering fundamentals from working well in a team, to rapid iteration, and testing strategies make AI coding more effective and will make you a better computer scientist. We will have you install GitHub Copilot as part of your standard toolset.
