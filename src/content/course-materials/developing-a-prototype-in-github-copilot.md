...
- **Be as clear as possible in your prompting.** A good strategy is often to iterate with the AI itself in chat mode to refine your prompt before you ask it to generate code. Plan mode in Copilot is great for this; but chat works as well
